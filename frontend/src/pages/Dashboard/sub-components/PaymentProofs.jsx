  ...
  return (
    <>
      <section
        ...
        }  left-0 w-full transition-all duration-300 h-screen bg-[#00000087] flex items-end`}
      >
        <div className="bg-white w-full h-[85%] sm:h-[75%] overflow-y-auto transition-all duration-300 ">
