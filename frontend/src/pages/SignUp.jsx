    ...
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
        <div className="bg-white mx-auto w-full h-auto px-2 flex flex-col gap-4 items-center py-4 justify-center rounded-md">
          <h1
            className={`text-[#024CAA] text-2xl font-bold mb-2 min-[480px]:text-4xl md:text-6xl xl:text-7xl 2xl:text-6xl`}
          >
            Register
          </h1>
          <form
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              <label className="font-semibold text-xl md:2xl flex flex-col">
                ...
                <span className="text-[12px] text-stone-500">
                  Provide your payment details only if you are registering as an
                  Auctioneer
                </span>
              </label>
            </div>
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                ...
                >
                  ...
                  <option value="HDFC">BOFA</option>
                  <option value="ICICI">TD Bank</option>
                  <option value="SBI">Chase Bank</option>
            ...
            <button
              className="bg-[#024CAA] w-[420px] font-semibold hover:bg-[#EC8305] transition-all duration-300 text-xl py-2 px-4 rounded-md text-white mx-auto lg:w-[640px] my-4"
              type="submit"
              disabled={loading}
            >
              {loading && "Registering..."}
